  ...
  return (
    <div className="h-screen flex item-center">
      <div className="py-10 flex items-center px-16">
        <div>
          <div className="text-3xl text-gray-600">Join in to Get <br />Started</div>

          <div className="mt-6 text-2xl text-left text-primary mb-2 font-bold">Create Account</div>
          <hr />
          <div className="mt-4">
