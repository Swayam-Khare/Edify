...
export default function TestCard({ subject, color }) {
  return (
    <div className={`rounded-lg overflow-hidden transform transition-transform duration-500 hover:scale-105 border-2 border-${color}-400`}>
      <div className={`flex justify-center text-center items-center h-40 px-4 bg-gradient-to-r from-${color}-200 to-${color}-300`}>
